...
<template>
  <div>
    <nav>
      <router-link to="/">Clases</router-link>
      <router-link to="/subclases">SubClases</router-link>
      <router-link to="/detalles">DetallesClase</router-link>
      <router-link to="/habilidad">SubClaseHabilidad</router-link>
    </nav>
